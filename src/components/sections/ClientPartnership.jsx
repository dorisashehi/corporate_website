...
export default function ClientPartnership() {
  return (
    <section id="how-we-work" className="py-20 md:py-28 bg-brand-navy text-white">
      <SectionTitle
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-12">
          {phases.map(({ label, icon: Icon, desc }) => (
            <div
              key={label}
              className="text-center p-8 rounded-2xl bg-white/10 border border-white/20 backdrop-blur-sm"
            >
